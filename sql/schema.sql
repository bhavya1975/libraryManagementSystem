...
-- speeds up searching with title
...
CREATE INDEX idx_author_name ON Author (name); -- for faster author search
...
-- the above query used for easy serch like available copies of book x
